...
- **User Listing:** Displays a table of users fetched from the backend, including Search functionality and Column Sorting (First Name, Last Name, Email).
...
- **Update User:** Allows editing of existing user information through a modal dialog.
